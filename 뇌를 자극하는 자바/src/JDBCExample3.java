    ...
    public static void main(String args[]) {
    	...
    	try {
            ...
            while(rs.next()) {
            	...
            	String goodsInfoCode = rs.getString(1); //rs.getString("jumincd");
            	String goodsInfoName   = rs.getString(2); //rs.getString("pname");
            	String price  = rs.getString(3); //rs.getString("gender");
